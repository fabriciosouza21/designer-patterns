This repository is based on the studies conducted on the website https://refactoring.guru/desgn-patterns. Its goal is to clarify the utilized patterns, with examples initially being written in java.
